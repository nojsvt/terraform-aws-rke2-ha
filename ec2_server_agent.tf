resource "aws_instance" "rke2_servers" {
  ...
  iam_instance_profile = aws_iam_instance_profile.acp_server_instance_profile.name
...
resource "aws_instance" "rke2_agents" {
  ...
  key_name      = var.key_name
  vpc_security_group_ids = [var.security_group_id]
  iam_instance_profile = aws_iam_instance_profile.acp_agent_instance_profile.name
